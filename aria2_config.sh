...
sed -i 343c\rpc-certificate=/www/server/panel/vhost/ssl/aria2.xhyhub.xyz/fullchain.pem aria2.conf
sed -i 346c\rpc-private-key=/www/server/panel/vhost/ssl/aria2.xhyhub.xyz/privkey.pem aria2.conf
